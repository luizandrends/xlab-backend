...
import FindeDebtByReasonController from '../controllers/FindeDebtByReasonController';
...
const findDebtByReasonController = new FindeDebtByReasonController();
...
debtRouter.get(
  ...
  ensureAuthenticated,
  findDebtByReasonController.find
);
